...
\begin{table}[h]
  \caption{Overview of the selection strategies that determine which trial arms are kept for the second stage}
...
We denote the proportion of patients per treatment in stage 1, compared to stage 2, with 
