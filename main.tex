...
\begin{figure}[ht]
\centering
\begin{tikzpicture}[auto,node distance=1cm,align=center,text width = 3cm, inner sep = 0.1cm, font=\scriptsize, outer sep= 0cm]
  \node[draw, ellipse, minimum height=1cm, text width=2cm] (ClinicalScenarios) at (0,0) {
