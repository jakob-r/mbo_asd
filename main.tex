...
\address[\inst{2}]{Second address} %please include the department and the postal address
...
% TODO: Jacob 
COPD trial
% Friede et al (2020) Biom J, Section 5.1 Clinical trial in COPD with treatment selection; other references: Barnes et al. (2011) and Donohue et al. (2010); Cuffe, Lawrence, Stone,&Vandemeulebroecke, 2014.
